            ...
            <div class="col-md-8">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="page-subtitle">Configure system reference data and business rules</p>
                    </div>
                </div>
            </div>
...
<div class="container-fluid">
    ...
    <div class="row g-4 mb-5">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-lg-3 col-md-6">
                            <a href="master_data_detail.php?table=sub_ledger_groups" class="text-decoration-none">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="master_data_detail.php?table=sub_ledger_categories" class="text-decoration-none">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="master_data_detail.php?table=sub_ledger_related_parties" class="text-decoration-none">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="master_data_detail.php?table=sub_ledger_status" class="text-decoration-none">
        ...
        <!-- NEW: Cash Flow Statement Configuration Section -->
        <div class="col-12">
            <div class="card dashboard-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="mb-0 fw-semibold">Cash Flow Statement Configuration</h5>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-lg-6 col-md-6">
                            <a href="master_data_detail.php?table=cash_flow_formats" class="text-decoration-none">
                                <div class="card border-0 h-100" style="background: linear-gradient(135deg, #1e3a8a 0%, #3b82f6 100%); color: white;">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <div class="h4 mb-1"><?php echo $utilization_stats['cash_flow_formats']['count']; ?></div>
                                                <div class="small">Cash Flow Formats</div>
                                            </div>
                                            <i class="bi bi-file-earmark-bar-graph" style="font-size: 2rem; opacity: 0.7;"></i>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <a href="cash_flow_configuration.php" class="text-decoration-none">
                                <div class="card border-0 h-100" style="background: linear-gradient(135deg, #7c3aed 0%, #a855f7 100%); color: white;">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <div class="h4 mb-1">18</div>
                                                <div class="small">Cash Flow Line Items</div>
                                            </div>
            ...
            <div class="card dashboard-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="mb-0 fw-semibold">Reference Data Management</h5>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-lg-4 col-md-6">
                            <a href="master_data_detail.php?table=titles" class="text-decoration-none">
                                <div class="card border-0 h-100" style="background: linear-gradient(135deg, #7c3aed 0%, #a855f7 100%); color: white;">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <div class="h4 mb-1"><?php echo $utilization_stats['titles']['count']; ?></div>
                                                <div class="small">Titles</div>
                                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <a href="master_data_detail.php?table=identity_types" class="text-decoration-none">
                                <div class="card border-0 h-100" style="background: linear-gradient(135deg, #ea580c 0%, #f97316 100%); color: white;">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <div class="h4 mb-1"><?php echo $utilization_stats['identity_types']['count']; ?></div>
                                                <div class="small">Identity Types</div>
                                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <a href="master_data_detail.php?table=companies" class="text-decoration-none">
                                <div class="card border-0 h-100" style="background: linear-gradient(135deg, #be185d 0%, #ec4899 100%); color: white;">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <div class="h4 mb-1"><?php echo $utilization_stats['companies']['count']; ?></div>
                                                <div class="small">Company Information</div>
                                            </div>
        ...
        <div class="col-12">
            <div class="card dashboard-card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-lg-3 col-md-6">
                            <a href="master_data_detail.php?table=investment_asset_classes" class="text-decoration-none">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="master_data_detail.php?table=equities_settings" class="text-decoration-none">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="master_data_detail.php?table=custodians" class="text-decoration-none">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="master_data_detail.php?table=brokers" class="text-decoration-none">
        ...
        <div class="col-12">
            <div class="card dashboard-card">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-lg-3 col-md-6">
                            <a href="master_data_detail.php?table=payment_frequencies" class="text-decoration-none">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="master_data_detail.php?table=bonds_economic_sectors" class="text-decoration-none">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="master_data_detail.php?table=bond_types" class="text-decoration-none">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <a href="master_data_detail.php?table=share_types" class="text-decoration-none">
            ...
            <div class="card dashboard-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="mb-0 fw-semibold">Accounting Configuration</h5>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-lg-4 col-md-6">
                            <a href="master_data_detail.php?table=gl_account_types" class="text-decoration-none">
                                <div class="card border-0 h-100" style="background: linear-gradient(135deg, #6b21a8 0%, #a855f7 100%); color: white;">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <div class="h4 mb-1"><?php echo $utilization_stats['gl_account_types']['count']; ?></div>
                                                <div class="small">GL Account Types</div>
                                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <a href="master_data_detail.php?table=gl_account_formats" class="text-decoration-none">
                                <div class="card border-0 h-100" style="background: linear-gradient(135deg, #be185d 0%, #ec4899 100%); color: white;">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <div class="h4 mb-1"><?php echo $utilization_stats['gl_account_formats']['count']; ?></div>
                                                <div class="small">GL Account Formats</div>
                                            </div>
                                            <i class="bi bi-layout-text-window" style="font-size: 2rem; opacity: 0.7;"></i>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <a href="master_data_detail.php?table=balance_sheet_reporting_formats" class="text-decoration-none">
                                <div class="card border-0 h-100" style="background: linear-gradient(135deg, #dc2626 0%, #f87171 100%); color: white;">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <div class="h4 mb-1"><?php echo $utilization_stats['balance_sheet_reporting_formats']['count']; ?></div>
                                                <div class="small">Balance Sheet Formats</div>
                                            </div>
                                            <i class="bi bi-file-earmark-spreadsheet" style="font-size: 2rem; opacity: 0.7;"></i>
                                        </div>
                                    </div>
                                </div>
                            </a>
        ...
        <!-- Transaction & Payment Configuration Section -->
        <div class="col-12">
            <div class="card dashboard-card">
                <div class="card-header bg-transparent border-0 pb-0">
                    <div class="d-flex align-items-center">
                        ...
                        <h5 class="mb-0 fw-semibold">Transaction & Payment Configuration</h5>
                    </div>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-lg-4 col-md-6">
                            <a href="master_data_detail.php?table=transaction_types" class="text-decoration-none">
                                <div class="card border-0 h-100" style="background: linear-gradient(135deg, #1e40af 0%, #3b82f6 100%); color: white;">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <div class="h4 mb-1"><?php echo $utilization_stats['transaction_types']['count']; ?></div>
                                                <div class="small">Transaction Types</div>
                                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <a href="master_data_detail.php?table=payment_methods" class="text-decoration-none">
                                <div class="card border-0 h-100" style="background: linear-gradient(135deg, #059669 0%, #34d399 100%); color: white;">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <div class="h4 mb-1"><?php echo $utilization_stats['payment_methods']['count']; ?></div>
                                                <div class="small">Payment Methods</div>
                                            </div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <a href="master_data_detail.php?table=ledger_types" class="text-decoration-none">
                                <div class="card border-0 h-100" style="background: linear-gradient(135deg, #b91c1c 0%, #f87171 100%); color: white;">
                                    <div class="card-body p-4">
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div>
                                                <div class="h4 mb-1"><?php echo $utilization_stats['ledger_types']['count']; ?></div>
                                                <div class="small">Ledger Types</div>
                                            </div>
            ...
            <div class="card dashboard-card">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        ...
                        <a href="../reports/advanced_reports.php" class="btn btn-outline-info">
