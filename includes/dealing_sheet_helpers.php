...
if (!function_exists('dealingSheetEnsureSchema')) {
    function dealingSheetEnsureSchema($db)
    {
        ...
        $sheetColumns = [
            ...
            'payment_status' => "ALTER TABLE dealing_sheets ADD COLUMN IF NOT EXISTS payment_status VARCHAR(30) NOT NULL DEFAULT 'pending' AFTER payment_receipt",
            'payment_receipt' => "ALTER TABLE dealing_sheets ADD COLUMN IF NOT EXISTS payment_receipt TEXT NULL AFTER payment_reference",
