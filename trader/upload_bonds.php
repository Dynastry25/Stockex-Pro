    ...
    try {
        ...
        if ($has_dismissed_by) {
            $stmt = $db->prepare("
                ...
                (trade_reference, client_name, security_id, security_name, trade_date, 
                 ...
                 additional_reference, status, treatment_type, created_by, created_at, updated_at,
        ...
        if ($has_dismissed_by) {
            $result = $stmt->execute([
                ...
                $trade_side,
                substr($additional_reference, 0, 100),
                $created_by
            ]);
        } else {
            $result = $stmt->execute([
        ...
        if ($result) {
            error_log("Successfully inserted regulatory fee assignment for bond trade: {$trade_reference} with additional_reference: {$additional_reference}");
        } else {
    ...
    try {
        $stmt = $db->prepare("
            ...
            (trade_reference, custodian_code, custodian_name, asset_class, security_id, security_name,
             ...
             trade_date, settlement_date, brokerage_fees, other_fees, total_fees, additional_reference, created_at)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, NOW())
        ");
        ...
        $result = $stmt->execute([
            ...
            $trade_data['additional_reference'] ?? ''
        ]);
...
function mapCSVRowToDatabaseBond($row) {
    ...
    error_log("Bond Date Mapping - Trade Date: {$trade_date}, Settlement Date: {$settlement_date}, Maturity Date: {$maturity_date}, Additional Ref: {$additional_reference}");
                        ...
                        if (!$has_real_errors && !empty($preview_data)) {
                            ...
                            try {
                                ...
                                foreach ($preview_data as $preview_row) {
                                    ...
                                    error_log("Trade {$trade_reference}: Trade Date: {$trade_date}, Settlement Date: {$settlement_date}, Additional Ref: {$additional_reference}");
                                    ...
                                    // Insert trade record (using Exchange Reference as trade_reference) - ADDED additional_reference
                                    ...
                                    $trade_insert_stmt->execute([
                                        ...
                                        substr($additional_reference, 0, 100), // NEW: Additional Reference
                                        $mapped_data['time_executed'] ?? null,
                                        $mapped_data['origin'] ?? null
                                    ]);
                                    
                                    error_log("Successfully inserted bond trade: {$trade_reference} with additional_reference: {$additional_reference}");
                                    ...
                                    if ($consideration > 0) {
                                        ...
                                        if (($fees['dse'] > 0 || $fees['cmsa'] > 0 || $fees['csd'] > 0)) {
                                            $assignment_result = recordRegulatoryFeeAssignment(
                                                ...
                                                $additional_reference // NEW: Pass additional_reference
                                            );
                                        ...
                                        if ($is_custodian_trade) {
                                            ...
                                            if ($custodian) {
                                                ...
                                                $custodian_trade_data = [
                                                    ...
                                                    'additional_reference' => $additional_reference // NEW: Pass additional_reference
                                                ];
                                ...
                                if ($processed > 0 || $duplicates_skipped > 0 || $client_trades_skipped > 0) {
                                    ...
                                    $success_message .= "<br><small><strong>Additional Reference:</strong> Captured from the 'Additional Reference' column - supports numbers, empty values, or 'MTP'.</small>";
...
<!-- HTML section remains EXACTLY as it was with Additional Reference column added -->
    ...
    <div class="page-header">
        <div class="container">
            ...
            <p class="text-primary small mb-0">
                ...
                <strong>NEW:</strong> <strong>Additional Reference</strong> column now supported - can contain a number, be empty, or contain "MTP".
            </p>
        </div>
    </div>
                ...
                <form method="POST" enctype="multipart/form-data" id="uploadForm">
                    <div class="mb-3">
                        ...
                        <div class="form-text">
                            ...
                            • <strong>Additional Reference</strong> - Optional: Number, empty, or "MTP"<br>
                            ...
                            <br><strong>Additional Reference:</strong> Supports numbers, empty values, or "MTP" for Mobile Trading Platform tracking.
                        </div>
                    </div>
                    ...
                    <table class="table table-sm table-hover mb-0">
                        ...
                        <tbody>
                            <?php foreach ($preview_data as $preview_row):
                                ...
                                $additionalRefDisplay = !empty($mapped_data['additional_reference']) ? 
                                    '<span class="badge bg-primary">' . htmlspecialchars($mapped_data['additional_reference']) . '</span>' : 
                            ...
                            <tr class="<?php echo $preview_row['has_errors'] ? 'table-danger' : 'table-success'; ?>">
                                ...
                                <td><?php echo $additionalRefDisplay; ?></td>
                                <td>
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <ul class="mb-3">
                            ...
                            <li><strong>Additional Reference</strong> - Captured from CSV, supports numbers, empty values, or "MTP".</li>
                        </ul>
                    </div>
                    <div class="col-md-6">
                ...
                <ul class="mb-0">
                    ...
                    <li><strong>Additional Reference</strong> can be a number, empty, or "MTP" for MTP payment tracking.</li>
                </ul>
            </div>
        </div>
    </div>
