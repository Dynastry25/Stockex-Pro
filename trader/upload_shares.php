...
<div class="container-fluid">
    <div class="page-header">
        <div class="container">
            ...
            <p class="text-warning small">
                <i class="bi bi-exclamation-triangle"></i> <strong>Commission Exemption:</strong> Company trades EXEMPT brokerage commission (411). All other fees (VAT, CMSA, DSE, CSDR, VRF) are recorded.
            </p>
        </div>
    </div>
