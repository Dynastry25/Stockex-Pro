...
if (isset($_GET['export_excel'])) {
    ...
    echo "<table border='1'>";
    echo "<tr><th colspan='12' style='font-size:16px;padding:15px;'>DEALING SHEET - " . htmlspecialchars($viewLabel) . " - " . htmlspecialchars($company_name) . "</th></tr>";
    echo "<tr><td colspan='12' class='header-row'>Generated: " . date('d/m/Y H:i:s') . " | Total Orders: " . count($sheets) . "</td></tr>";
    ...
    if (empty($sheets)) {
        echo "<tr><td colspan='12' class='center'>No orders found</td></tr>";
    } else {
        foreach ($sheets as $sheet) {
            ...
            echo "<td class='center'>" . htmlspecialchars($sheet['trade_date'] ?? '—') . "</td>";
                        ...
                        <?php else: ?>
                            ...
                            ?>
                                <tr class="<?php echo $rowClass; ?>">
                                    ...
                                    <td><?php echo htmlspecialchars($sheet['trade_date'] ?? '—'); ?></td>
                                    <td>
                                        <?php
